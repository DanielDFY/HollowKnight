...
public class GruzMotherController : EnemyController
{
    ...
    {
        public abstract bool checkValid(GruzMotherController enemyController);
        public abstract void Execute(GruzMotherController enemyController);
    }
    ...
    public class Patrol : State
    {
        ...
        {
            GruzMotherController gruzMotherController = (GruzMotherController)enemyController;
            if (!_currentState.checkValid(gruzMotherController) || _isFinished)
            {
                ...
                gruzMotherController.StartCoroutine(executeCoroutine(gruzMotherController.behaveInterval()));
            }

            _currentState.Execute(gruzMotherController);
        }
    ...
    public class Chase : State
    {
        ...
        {
            GruzMotherController gruzMotherController = (GruzMotherController)enemyController;
            float dist = gruzMotherController.playerEnemyDistance();
            gruzMotherController.walk(Math.Abs(dist) < 0.1f ? 0 : dist);
        }
    }

    public class Idle : PatrolState
    {
        public override bool checkValid(GruzMotherController gruzMotherController)
        {
            return gruzMotherController.reachEdge() == 0;
        }

        public override void Execute(GruzMotherController gruzMotherController)
        {
            gruzMotherController.walk(0);
        }
    }
    public class WalkingLeft : PatrolState
    {
        public override bool checkValid(GruzMotherController gruzMotherController)
        {
            return gruzMotherController.reachEdge() != -1;
        }

        public override void Execute(GruzMotherController gruzMotherController)
        {
            gruzMotherController.walk(-1);
        }
    }
